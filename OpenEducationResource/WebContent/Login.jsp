...
<script language="javascript" type="text/javascript">
	function doSubmit() {
		...
		var test = <%=request.getAttribute("errMessage")%>;
		
		if(test!=null)
			{
			document.getElementById("error").style.visibility = "visible"
			      document.getElementById("error").innerHTML = request.getAttribute("errMessage");
							...
							<div class="login">
								...
								<form name="form"
									...
									<button type="submit" onclick="doSubmit()"
										class="btn btn-primary btn-block btn-large">Submit</button>
										
									<label type="hidden" style="color:red" id="error"></label>
