...
<pre><a href="editor.jsp">Back</a>        <a href="index.html">Logout</a> </pre>

<table border="1">
    <tr>
        <th>File Name</th><th>Keywords</th><th> Email  </th><th>File Id </th>
</tr>
...
<tr>
    <td><%=fname%></td><td><%=key%> </td><td>  <%=name%>  </td><td>  <%=fileid%>  </td>
    
    
    <td>  <form action="edownload12" method ="get">
                             
                                     <input type="hidden" value="<%=name%>" name="lat">
                                <input type="hidden" value="<%=fileid%>" name="lng">
                                <input type="submit" value="Download">
                              
                                 </form>
    </td>
    
    <td>  <form action="accept" method ="get">
                             
            
              <input type="hidden" value="<%=fname%>" name="f1">
    ...
    <td>  <form action="reject" method ="get">
