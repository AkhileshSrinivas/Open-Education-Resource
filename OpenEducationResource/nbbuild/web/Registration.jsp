...
<body>
	...
	<form action="RegisterServlet" method="post">
		...
		<fieldset>
			...
			<label for="name">Personal Address:</label>
			<textarea id="personaladdress" name="personaladdress"></textarea>


			<label>Sex:</label> 
			
			<input type="radio" id="under_13" value="male"
				name="sex"><label for="under_13" class="light">Male</label><br>
			<input type="radio" id="over_13" value="female" name="sex"><label
		...
		<fieldset>
			...
			<label>Interests:</label> <input type="checkbox" id="development"
