...
<html>
    ...
    <body>
        ...
        <%
            ...
            Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/learningframework?characterEncoding=utf8&useSSL=false&useUnicode=true", "root", "rootqwer");
